...
// #define DEBUG_SQUARE_WAVE 1
		...
		LOG_DEBUG("SPEAKER: square-wave [prev_pos={}, prev_mode={}, mode={}, prev_pit={}, pit={}]",
		        spkr.prev_pos, spkr.prev_mode, spkr.mode,
		        spkr.prev_pit_mode, spkr.pit_mode);
	} else {
		LOG_DEBUG("SPEAKER: sine-wave [prev_pos={}, prev_mode={}, mode={}, prev_pit={}, pit={}], ",
		        spkr.prev_pos, spkr.prev_mode, spkr.mode,
		        spkr.prev_pit_mode, spkr.pit_mode);
#endif
	}
	...
	if (fabs(vol) > AMPLITUDE_NEUTRAL)
		LOG_INFO("SPEAKER: Adding pos={:3s}, pit={}|%" PRIuPTR
		        ", pwm={}|{}, volume={:6.0f}",
