...
{
	/*Add Messages */
	MSG_Add("PROGRAM_MOUNT_CDROMS_FOUND", _("CDROMs found: %d\n"));
	MSG_Add("PROGRAM_MOUNT_STATUS_DRIVE", _("Drive"));
	MSG_Add("PROGRAM_MOUNT_STATUS_TYPE", _("Type"));
	MSG_Add("PROGRAM_MOUNT_STATUS_LABEL", _("Label"));
	MSG_Add("PROGRAM_MOUNT_STATUS_2", _("Drive %c is mounted as %s\n"));
	MSG_Add("PROGRAM_MOUNT_STATUS_1", _("The currently mounted drives are:\n"));
	MSG_Add("PROGRAM_MOUNT_ERROR_1", _("Directory %s doesn't exist.\n"));
	MSG_Add("PROGRAM_MOUNT_ERROR_2", _("%s isn't a directory\n"));
	MSG_Add("PROGRAM_MOUNT_ILL_TYPE", _("Illegal type %s\n"));
	MSG_Add("PROGRAM_MOUNT_ALREADY_MOUNTED",
	        _("Drive %c already mounted with %s\n"));
	MSG_Add("PROGRAM_MOUNT_UMOUNT_NOT_MOUNTED", _("Drive %c isn't mounted.\n"));
	MSG_Add("PROGRAM_MOUNT_UMOUNT_SUCCESS",
	        _("Drive %c has successfully been removed.\n"));
	MSG_Add("PROGRAM_MOUNT_UMOUNT_NO_VIRTUAL",
	        _("Virtual Drives can not be unMOUNTed.\n"));
	MSG_Add("PROGRAM_MOUNT_DRIVEID_ERROR",
	        _("'%c' is not a valid drive identifier.\n"));
	MSG_Add("PROGRAM_MOUNT_WARNING_WIN",
	        _("\033[31;1mMounting c:\\ is NOT recommended. Please mount a (sub)directory next time.\033[0m\n"));
	MSG_Add("PROGRAM_MOUNT_WARNING_OTHER",
	        _("\033[31;1mMounting / is NOT recommended. Please mount a (sub)directory next time.\033[0m\n"));
	MSG_Add("PROGRAM_MOUNT_NO_OPTION",
	        _("Warning: Ignoring unsupported option '%s'.\n"));
	MSG_Add("PROGRAM_MOUNT_OVERLAY_NO_BASE",
	        _("A normal directory needs to be MOUNTed first before an overlay can be added on top.\n"));
	MSG_Add("PROGRAM_MOUNT_OVERLAY_INCOMPAT_BASE",
	        _("The overlay is NOT compatible with the drive that is specified.\n"));
	MSG_Add("PROGRAM_MOUNT_OVERLAY_MIXED_BASE",
	        _("The overlay needs to be specified using the same addressing as the underlying drive. No mixing of relative and absolute paths."));
	MSG_Add("PROGRAM_MOUNT_OVERLAY_SAME_AS_BASE",
	        _("The overlay directory can not be the same as underlying drive.\n"));
	MSG_Add("PROGRAM_MOUNT_OVERLAY_GENERIC_ERROR", _("Something went wrong.\n"));
	MSG_Add("PROGRAM_MOUNT_OVERLAY_STATUS",
	        _("Overlay %s on drive %c mounted.\n"));
	MSG_Add("PROGRAM_MOUNT_MOVE_Z_ERROR_1",
	        _("Can't move drive Z. Drive %c is mounted already.\n"));

	MSG_Add("PROGRAM_MEM_CONVEN", _("%10d kB free conventional memory\n"));
	MSG_Add("PROGRAM_MEM_EXTEND", _("%10d kB free extended memory\n"));
	MSG_Add("PROGRAM_MEM_EXPAND", _("%10d kB free expanded memory\n"));
	MSG_Add("PROGRAM_MEM_UPPER",
	        _("%10d kB free upper memory in %d blocks (largest UMB %d kB)\n"));

	MSG_Add("PROGRAM_LOADFIX_ALLOC", _("%d kB allocated.\n"));
	MSG_Add("PROGRAM_LOADFIX_DEALLOC", _("%d kB freed.\n"));
	MSG_Add("PROGRAM_LOADFIX_DEALLOCALL", _("Used memory freed.\n"));
	MSG_Add("PROGRAM_LOADFIX_ERROR", _("Memory allocation error.\n"));

	MSG_Add("MSCDEX_SUCCESS", _("MSCDEX installed.\n"));
	MSG_Add("MSCDEX_ERROR_MULTIPLE_CDROMS",
	        _("MSCDEX: Failure: Drive-letters of multiple CD-ROM drives have to be continuous.\n"));
	MSG_Add("MSCDEX_ERROR_NOT_SUPPORTED",
	        _("MSCDEX: Failure: Not yet supported.\n"));
	MSG_Add("MSCDEX_ERROR_PATH",
	        _("MSCDEX: Specified location is not a CD-ROM drive.\n"));
	MSG_Add("MSCDEX_ERROR_OPEN",
	        _("MSCDEX: Failure: Invalid file or unable to open.\n"));
	MSG_Add("MSCDEX_TOO_MANY_DRIVES",
	        _("MSCDEX: Failure: Too many CD-ROM drives (max: 5). MSCDEX Installation failed.\n"));
	MSG_Add("MSCDEX_LIMITED_SUPPORT",
	        _("MSCDEX: Mounted subdirectory: limited support.\n"));
	MSG_Add("MSCDEX_INVALID_FILEFORMAT",
	        _("MSCDEX: Failure: File is either no ISO/CUE image or contains errors.\n"));
	MSG_Add("MSCDEX_UNKNOWN_ERROR", _("MSCDEX: Failure: Unknown error.\n"));
	MSG_Add("MSCDEX_WARNING_NO_OPTION",
	        _("MSCDEX: Warning: Ignoring unsupported option '%s'.\n"));

	MSG_Add("PROGRAM_RESCAN_SUCCESS", _("Drive cache cleared.\n"));

	MSG_Add("PROGRAM_INTRO",
	        _("\033[2J\033[32;1mWelcome to DOSBox Staging\033[0m, an x86 emulator with sound and graphics.\n"
	...
	MSG_Add("PROGRAM_INTRO_MOUNT_START",
	        _("\033[2J\033[32;1mHere are some commands to get you started:\033[0m\n"
	          "Before you can use the files located on your own filesystem,\n"
	          "You have to mount the directory containing the files.\n"
	          "\n"));
	MSG_Add("PROGRAM_INTRO_MOUNT_WINDOWS",
	        _("\033[44;1m\xC9\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD"
	...
	MSG_Add("PROGRAM_INTRO_MOUNT_OTHER",
	        _("\033[44;1m\xC9\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD"
	          "\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD"
	...
	MSG_Add("PROGRAM_INTRO_MOUNT_END",
	        _("After successfully mounting the disk you can type \033[34;1mc:\033[0m to go to your freshly\n"
	...
	MSG_Add("PROGRAM_INTRO_CDROM_WINDOWS",
	        _("\033[2J\033[32;1mHow to mount a virtual CD-ROM Drive in DOSBox:\033[0m\n"
	...
	MSG_Add("PROGRAM_INTRO_SPECIAL",
	        _("\033[2J\033[32;1mSpecial keys:\033[0m\n"
	...
	MSG_Add("PROGRAM_BOOT_NOT_EXIST",
	        _("Bootdisk file does not exist.  Failing.\n"));
	MSG_Add("PROGRAM_BOOT_NOT_OPEN", _("Cannot open bootdisk file.  Failing.\n"));
	MSG_Add("PROGRAM_BOOT_WRITE_PROTECTED",
	        _("Image file is read-only! Might create problems.\n"));
	MSG_Add("PROGRAM_BOOT_PRINT_ERROR",
	        _("This command boots DOSBox from either a floppy or hard disk image.\n\n"
	...
	MSG_Add("PROGRAM_BOOT_UNABLE", _("Unable to boot off of drive %c"));
	MSG_Add("PROGRAM_BOOT_IMAGE_OPEN", _("Opening image file: %s\n"));
	MSG_Add("PROGRAM_BOOT_IMAGE_NOT_OPEN", _("Cannot open %s"));
	MSG_Add("PROGRAM_BOOT_BOOT", _("Booting from drive %c...\n"));
	MSG_Add("PROGRAM_BOOT_CART_WO_PCJR",
	        _("PCjr cartridge found, but machine is not PCjr"));
	MSG_Add("PROGRAM_BOOT_CART_LIST_CMDS",
	        _("Available PCjr cartridge commands: %s"));
	MSG_Add("PROGRAM_BOOT_CART_NO_CMDS", _("No PCjr cartridge commands found"));

	MSG_Add("PROGRAM_LOADROM_SPECIFY_FILE",
	        _("Must specify ROM file to load.\n"));
	MSG_Add("PROGRAM_LOADROM_CANT_OPEN", _("ROM file not accessible.\n"));
	MSG_Add("PROGRAM_LOADROM_TOO_LARGE", _("ROM file too large.\n"));
	MSG_Add("PROGRAM_LOADROM_INCOMPATIBLE",
	        _("Video BIOS not supported by machine type.\n"));
	MSG_Add("PROGRAM_LOADROM_UNRECOGNIZED", _("ROM file not recognized.\n"));
	MSG_Add("PROGRAM_LOADROM_BASIC_LOADED", _("BASIC ROM loaded.\n"));

	MSG_Add("SHELL_CMD_IMGMOUNT_HELP",
	        _("mounts compact disc image(s) or floppy disk image(s) to a given drive letter.\n"));

	MSG_Add("SHELL_CMD_IMGMOUNT_HELP_LONG",
	        _("Mount a CD-ROM, floppy, or disk image to a drive letter.\n"
	          "\n"
	          "Usage:\n"
	...
	MSG_Add("SHELL_CMD_MOUNT_HELP",
	        _("maps physical folders or drives to a virtual drive letter.\n"));

	MSG_Add("SHELL_CMD_MOUNT_HELP_LONG",
	        _("Mount a directory from the host OS to a drive letter.\n"
	          "\n"
	          "Usage:\n"
	...
	MSG_Add("PROGRAM_IMGMOUNT_SPECIFY_DRIVE",
	        _("Must specify drive letter to mount image at.\n"));
	MSG_Add("PROGRAM_IMGMOUNT_SPECIFY2",
	        _("Must specify drive number (0 or 3) to mount image at (0,1=fda,fdb;2,3=hda,hdb).\n"));
	MSG_Add("PROGRAM_IMGMOUNT_SPECIFY_GEOMETRY",
	        _("For \033[33mCD-ROM\033[0m images:   \033[34;1mIMGMOUNT drive-letter location-of-image -t iso\033[0m\n"
	          "\n"
	...
	MSG_Add("PROGRAM_IMGMOUNT_INVALID_GEOMETRY",
	        _("Could not extract drive geometry from image.\n"
	          "Use parameter -size bps,spc,hpc,cyl to specify the geometry.\n"));
	MSG_Add("PROGRAM_IMGMOUNT_TYPE_UNSUPPORTED",
	        _("Type '%s' is unsupported. Specify 'floppy', 'hdd', 'cdrom', or 'iso'.\n"));
	MSG_Add("PROGRAM_IMGMOUNT_FORMAT_UNSUPPORTED",
	        _("Format \"%s\" is unsupported. Specify \"fat\" or \"iso\" or \"none\".\n"));
	MSG_Add("PROGRAM_IMGMOUNT_SPECIFY_FILE",
	        _("Must specify file-image to mount.\n"));
	MSG_Add("PROGRAM_IMGMOUNT_FILE_NOT_FOUND", _("Image file not found.\n"));
	MSG_Add("PROGRAM_IMGMOUNT_MOUNT",
	        _("To mount directories, use the \033[34;1mMOUNT\033[0m command, not the \033[34;1mIMGMOUNT\033[0m command.\n"));
	MSG_Add("PROGRAM_IMGMOUNT_ALREADY_MOUNTED",
	        _("Drive already mounted at that letter.\n"));
	MSG_Add("PROGRAM_IMGMOUNT_CANT_CREATE", _("Can't create drive from file.\n"));
	MSG_Add("PROGRAM_IMGMOUNT_MOUNT_NUMBER",
	        _("Drive number %d mounted as %s\n"));
	MSG_Add("PROGRAM_IMGMOUNT_NON_LOCAL_DRIVE",
	        _("The image must be on a host or local drive.\n"));
	MSG_Add("PROGRAM_IMGMOUNT_MULTIPLE_NON_CUEISO_FILES",
	        _("Using multiple files is only supported for cue/iso images.\n"));

	MSG_Add("PROGRAM_KEYB_INFO", _("Codepage %i has been loaded\n"));
	MSG_Add("PROGRAM_KEYB_INFO_LAYOUT",
	        _("Codepage %i has been loaded for layout %s\n"));
	MSG_Add("PROGRAM_KEYB_SHOWHELP",
	        _("\033[32;1mKEYB\033[0m [keyboard layout ID[ codepage number[ codepage file]]]\n\n"
	          "Some examples:\n"
	...
	MSG_Add("PROGRAM_KEYB_NOERROR",
	        _("Keyboard layout %s loaded for codepage %i\n"));
	MSG_Add("PROGRAM_KEYB_FILENOTFOUND", _("Keyboard file %s not found\n\n"));
	MSG_Add("PROGRAM_KEYB_INVALIDFILE", _("Keyboard file %s invalid\n"));
	MSG_Add("PROGRAM_KEYB_LAYOUTNOTFOUND",
	        _("No layout in %s for codepage %i\n"));
	MSG_Add("PROGRAM_KEYB_INVCPFILE",
	        _("None or invalid codepage file for layout %s\n\n"));
